...
Flickable {
    ...
    Connections {
        ...
        function onActiveMatchChanged() { root.match = TournamentManager.activeMatch }
    }
    Connections {
        target: root.match
    ...
    ColumnLayout {
        ...
        SectionCard {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    spacing: 2
                    Text { text: "Current time"; font.family: Theme.sansFamily; font.pixelSize: 12; color: Theme.walnutMuted }
                    Text {
                        text: Qt.formatDateTime(root.now, "yyyy-MM-dd HH:mm:ss")
                ...
                AppButton {
                    ...
                    onClicked: root.match.start(root.now)
                }
            }
        ...
        SectionCard {
            ...
            RowLayout {
                ...
                AppButton { text: "White wins"; onClicked: root.match.finish(ChessEnums.WhiteWins, root.now) }
                AppButton { text: "Black wins"; onClicked: root.match.finish(ChessEnums.BlackWins, root.now) }
                AppButton { text: "Draw"; primary: false; onClicked: root.match.finish(ChessEnums.Draw, root.now) }
                Item { Layout.fillWidth: true }
                AppButton {
